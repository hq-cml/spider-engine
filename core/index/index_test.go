...
func TestNewAndAddDoc(t *testing.T) {
	...
	var err error
	err = idx1.AddDocument(0, 100); if err != nil {t.Fatal(err)}
	err = idx1.AddDocument(1, 200); if err != nil {t.Fatal(err)}
	...
	err = idx2.AddDocument(0, 1556064868); if err != nil {t.Fatal(err)}
	iv, b = idx2.GetInt(0)
	if !b {
		t.Fatal("Sth wrong")
	}
	...
	err = idx4.AddDocument(0, "2019-01-01 00:00:00"); if err != nil {t.Fatal(err)}
	iv, b = idx4.GetInt(0)
	if !b {
		t.Fatal("Sth wrong")
	}
...
func TestPersist(t *testing.T) {
	...
	err = idx1.AddDocument(0, 100); if err != nil {t.Fatal(err)}
	err = idx1.AddDocument(1, 200); if err != nil {t.Fatal(err)}
	err = idx1.AddDocument(2, 300); if err != nil {t.Fatal(err)}
	...
	idx3 := NewEmptyForwardIndex(IDX_TYPE_STRING, 0) //数字型存入字符
	err = idx3.AddDocument(0, "abc"); if err != nil {t.Fatal(err)}
	err = idx3.AddDocument(1, "efg"); if err != nil {t.Fatal(err)}
